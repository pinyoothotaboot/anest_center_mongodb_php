        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">ครุภัณฑ์รอการอนุมัติซ่อม</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <!-- ------------------------------------------------------ -->
                ...
                <div class="panel box box-primary">
                  <div class="box-header with-border">
                    ...
                    <a class="btn btn-primary btn-xs" href="<?php echo URL.'repair/accept/'.(string)$value['id'];?>">อนุมัติ</a>
                    <a class="btn btn-danger btn-xs" href="<?php echo URL.'repair/cancel/'.(string)$value['id'];?>">ยกเลิก</a>
                    </div>
                  </div>
        ...
        <div class="col-xs-6">
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tr>
                <th>Status:</th>
                <td><?php echo "รอการอนุมัติซ่อม";?></td>
              </tr>
            </table>
          </div>
        </div>
