  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="">งานสลับเปลี่ยนครุภัณฑ์</a></li>
              </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="change" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>SAP</th>
                  <th>S/N</th>
                ...
                <td><?php echo $value['building'].' '.$value['floor'].' '.$value['room'];?></td>
                  ...
                  <td>
                  	<a href="<?php echo URL.'change/switching/'.(string)$value['id'];?>" >เปลี่ยนสถานที่</a>
